      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-14 grid md:grid-cols-4 gap-10">
        <div className="md:col-span-2">
          ...
          <p className="mt-3 text-sm text-muted-foreground max-w-sm leading-relaxed">
            Engenharia de processos, hiperautomação e IA aplicada para empresas que
            já não cabem mais em planilhas.
          </p>
        </div>
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
            <li><a href="#diagnostico" className="hover:text-foreground">O Diagnóstico</a></li>
            <li><a href="#sistemas" className="hover:text-foreground">Sistemas</a></li>
            <li><a href="#lideranca" className="hover:text-foreground">Insights</a></li>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
            <li><a href="http://wa.me/5511954210088" className="hover:text-foreground">WhatsApp Direto</a></li>
            <li><a href="mailto:contato@martines.halftech.com" className="hover:text-foreground">contato@martines.halftech.com</a></li>
          </ul>
        </div>
      </div>
