...
const staticPosts = [
  {
    ...
    excerpt: "Não é o modelo. É o processo. Um framework para evitar a armadilha do POC eterno.",
    meta: "8 min de leitura · Estratégia",
    link: "#",
  },
  {
    title: "De 14 planilhas a um único fluxo: redução de 72% no ciclo de aprovação",
    excerpt: "Estudo de caso real: indústria de médio porte, integração ERP legado + n8n + IA.",
    meta: "12 min de leitura · Caso",
    link: "#",
  },
  {
    title: "As-Is, To-Be e o erro de pular o mapeamento operacional",
    excerpt: "Como Business Translators traduzem o caos invisível em arquitetura executável.",
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
          <div className="max-w-2xl">
            <p className="text-xs uppercase tracking-[0.18em] text-brand font-medium">Insights</p>
